...
export default function Login() {
  ...
  return (
    <div className='flex justify-center w-full h-screen bg-slate-900 text-white'>
      <form className='flex flex-col justify-center  w-1/3 bg-slate-800 rounded-2xl shadow-2xl p-8 my-8'>
        ...
        <div className='flex justify-center items-center mt-8'>
          <Button
            type="submit"
            onClick={loginUser}
            className={`py-1.5 px-6 w-fit border rounded-full ${formState.isFormValid ? 'bg-green-500 hover:scale-105' : 'bg-red-500/90'}`}
